...
ver_4.10.2(){
	#[[ ! -f /lib/modules/`uname -r`/kernel/net/ipv4/tcp_nanqinlang.ko ]] && echo -e "${Info} loading mod" && cd /lib/modules/`uname -r`/kernel/net/ipv4 && wget -O tcp_nanqinlang.ko "https://raw.githubusercontent.com/afeigorgor/general/master/General/Debian/mod/tcp_nanqinlang-for-v4.10.2.ko" && insmod tcp_nanqinlang.ko && depmod -a
	#[[ ! -f /lib/modules/`uname -r`/kernel/net/ipv4/tcp_nanqinlang.ko ]] && echo -e "${Error} download mod failed,please check !" && exit 1

	#download
	[[ ! -f /lib/modules/`uname -r`/kernel/net/ipv4/tcp_nanqinlang.ko ]] && echo -e "${Info} loading mod" && cd /lib/modules/`uname -r`/kernel/net/ipv4 && wget -O tcp_nanqinlang.ko "https://raw.githubusercontent.com/afeigorgor/general/master/General/Debian/mod/tcp_nanqinlang-for-v4.10.2.ko"
	#check and install
